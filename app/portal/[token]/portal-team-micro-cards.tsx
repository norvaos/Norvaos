      ...
      <div className="mt-3 space-y-1.5">
        {member.email && (
          <a
            ...
            className="flex items-center gap-2 rounded-lg bg-slate-50 px-3 py-2 text-xs text-blue-600 hover:bg-blue-950/30 hover:text-blue-400 transition-colors active:scale-[0.98] touch-manipulation"
          >
