/**
 * Regulator-Mirror 3.0 Pre-Submission IRCC AI-Readability Audit-Optimizer
 * Keyword Catalogue & Structural Rules
 *
 * IRCC's automated pre-screening system evaluates immigration applications.
...
export type IRCCCategory = keyof typeof IRCC_KEYWORDS;

// ---------------------------------------------------------------------------
// Metadata Zones — where keyword placement has highest IRCC's automated system impact
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Structural Rules — IRCC's automated system pre-screen checks
// ---------------------------------------------------------------------------
...
export const STRUCTURE_RULES = [
  {
    ...
    severity: 'critical',
    description:
      "IRCC's automated system relies on bookmark navigation to locate sections. PDFs without bookmarks are flagged for manual review, which delays processing.",
  },
  {
    id: 'STRUCT-002',
    ...
    severity: 'critical',
    description:
      "The cover letter provides IRCC's automated system with the application summary and keyword context. It must appear as the first document or first bookmarked section.",
  },
  {
    id: 'STRUCT-003',
    ...
    severity: 'critical',
    description:
      "Image-only PDFs cannot be parsed by IRCC's automated system\u2019s text extraction. All forms must contain an embedded text layer (OCR at minimum).",
  },
  {
    id: 'STRUCT-004',
  ...
  },
  {
    ...
    severity: 'warning',
    description:
      "Documents exceeding 10 MB may time out during IRCC's automated system processing. Compress images and flatten form fields to reduce file size.",
  },
  {
    id: 'STRUCT-006',
  ...
  },
  {
    ...
    severity: 'critical',
    description:
      "Encrypted or password-protected PDFs cannot be opened by IRCC's automated system. Remove all security restrictions before submission.",
  },
  {
    id: 'STRUCT-008',
  ...
  },
  {
    ...
    severity: 'warning',
    description:
      "Merging unrelated supporting documents into a single PDF prevents IRCC's automated system from categorising them correctly. Keep each document separate.",
  },
  {
    id: 'STRUCT-010',
    ...
    severity: 'info',
    description:
      "Cross-references between the cover letter and annexes (e.g., 'See Annex A') help IRCC's automated system map supporting evidence to legal arguments.",
  },
