        ...
        <Container style={containerStyle}>
          ...
          <Section style={contentStyle}>
            ...
            <Text style={paragraphStyle}>
              You have a document to review and sign for matter{' '}
              <strong>{matterReference}</strong>.
            </Text>
...
export async function renderSigningRequestEmail(
  ...
  const text = [
    greeting,
    '',
    `You have a document to review and sign for matter ${props.matterReference}.`,
    '',
    `Document: ${props.documentTitle}`,
    props.totalAmount ? `Total Amount: ${props.totalAmount}` : '',
    '',
