...
export function BookingConfirmationEmail({
  ...
  return (
    <Html>
      <Head />
      <Preview>
        Appointment confirmed for {appointmentDate} at {appointmentTime}
      </Preview>
        ...
        <Container style={containerStyle}>
          ...
          <Section style={footerStyle}>
            <Text style={footerTextStyle}>
              You are receiving this email because you have an appointment with {firmName}.
            </Text>
            <Text style={footerTextStyle}>
...
export async function renderBookingConfirmationEmail(props: BookingConfirmationEmailProps): Promise<{
  html: string
  text: string
  subject: string
}> {
