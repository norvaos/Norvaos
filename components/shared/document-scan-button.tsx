...
export function DocumentScanButton({
  ...
  const confidenceColour = (c: number) => {
    if (c >= 80) return 'border-emerald-500/30 text-emerald-400 bg-emerald-950/30'
    if (c >= 50) return 'border-amber-500/30 text-amber-400 bg-amber-950/30'
          ...
          {scanResult && (
            <div className="space-y-4 py-1">
              ...
              {scanResult.confidence < 50 && (
                <div className="flex items-start gap-2 p-3 bg-amber-950/30 border border-amber-500/20 rounded-lg">
