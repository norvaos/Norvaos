    ...
    <div className="flex items-center gap-2 w-full py-2 px-2 hover:bg-muted/50 rounded-lg transition-colors">
      ...
      <div className="flex items-center gap-1.5">
        ...
        {staleCount > 0 && (
          <Badge
            variant="outline"
            className="text-[10px] py-0 px-1.5 leading-4 border-amber-500/30 text-amber-400 bg-amber-950/30"
          >
            {staleCount} stale
          </Badge>
        )}
        ...
        {conflictCount > 0 && (
          <Badge
            variant="outline"
            className="text-[10px] py-0 px-1.5 leading-4 border-red-500/30 text-red-400 bg-red-950/30"
          >
