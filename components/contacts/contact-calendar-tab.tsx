...
const EVENT_TYPE_LABELS: Record<string, { label: string; color: string }> = {
  meeting: { label: 'Meeting', color: 'bg-blue-950/40 text-blue-400' },
  consultation: { label: 'Consultation', color: 'bg-indigo-100 text-indigo-700' },
  court_date: { label: 'Court', color: 'bg-red-950/40 text-red-400' },
  deadline: { label: 'Deadline', color: 'bg-amber-950/40 text-amber-400' },
  reminder: { label: 'Reminder', color: 'bg-emerald-950/40 text-emerald-400' },
