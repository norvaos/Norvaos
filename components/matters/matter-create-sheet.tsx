...
export function MatterCreateSheet({ open, onOpenChange, defaultContactId }: MatterCreateSheetProps) {
  ...
  async function handleSubmit(values: MatterFormValues) {
    ...
    const result = await createMatter.mutateAsync({
      ...
      matter_type_id: matterValues.matter_type_id || null,
      case_type_id: matterValues.case_type_id || null,
      contact_id: contact_id || null,
      pipeline_id: matterValues.pipeline_id || null,
      stage_id: matterValues.stage_id || null,
      matter_stage_pipeline_id: matterValues.matter_stage_pipeline_id || null,
      initial_matter_stage_id: matterValues.initial_matter_stage_id || null,
      ...
      followup_lawyer_id: matterValues.followup_lawyer_id || null,
